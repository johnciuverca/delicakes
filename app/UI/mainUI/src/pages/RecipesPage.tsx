                ...
                <div className="recipe-form recipe-delete-panel">
                    ...
                    <div className="recipe-form-actions">
                        <button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'Deleting...' : `Delete Selected (${selectedRecipeIds.length})`}
                        </button>

                        <button type="button" className="recipe-btn" onClick={resetDeleteState}>
                            Cancel
                        </button>
                    </div>
                </div>
                    ...
                    return (
                        ...
                        >
                            <div className="recipe-image-wrap">
                                <img className="recipe-image" src={recipe.imageSrc} alt={recipe.title} />
